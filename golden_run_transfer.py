#!/usr/bin/env python3
"""
golden_run_transfer.py

Golden-path smoke test for transfer template:
...
def main() -> int:
    ...
    event_json = repo_root / "out" / "json" / "transfer_test.json"
    ...
    print("Verified: transfer minimal contract ops + routing")
